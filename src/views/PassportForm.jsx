...
import {
  FileText, ClipboardList, User, GraduationCap, Heart,
  Users, MapPin, Check, AlertCircle,
...
export default function PassportForm() {
  ...
  const validateStep = (s) => {
    ...
    if (s === 3) {
      ...
      if (!placeOfBirth.trim()) return { msg: 'Please enter your place of birth.', step: 3 }
    }
    if (s === 4) {
    ...
    if (s === 5 && !maritalStatus) return { msg: 'Please select your marital status.', step: 5 }
    if (s === 6) {
    ...
    if (s === 7) {
      ...
      if (!district.trim())    return { msg: 'Please enter your district.', step: 7 }
    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Your passport application is submitted. Updates will be sent to <strong>{mobile}</strong>.</p>
          <div className="pf5-done-pills">
            <span>₹99 Paid</span><span>Submitted</span><span>Processing</span>
          </div>
          <div className="pf5-footer">
            <Link href="/passport" className="pf5-cta-btn" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ? Back to Passport
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/passport">Passport</Link><span> / </span><span>Apply</span>
      </div>
      <div className="pf5-card">
        ...
        <div className="pf5-content">
          ...
          {step === 3 && (
            <>
              ...
              <Field label="Place of Birth (Village / Town / City)">
                <ValidInp valid={placeOfBirth.trim().length > 0}>
                  <input className="pf5-inp" type="text" placeholder="Enter place of birth"
          ...
          {step === 5 && (
            <Field label="Marital Status">
              <RadioGroup name="marital"
                ...
                value={maritalStatus} onChange={setMaritalStatus} wrap />
            </Field>
          )}
          ...
          {step === 7 && (
            <>
              ...
              <Field label="District">
                <ValidInp valid={district.trim().length > 0}>
                  <input className="pf5-inp" type="text" placeholder="Enter your district"
