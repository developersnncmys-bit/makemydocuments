    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Your Egypt Tourist Visa application is submitted. Updates will be sent to <strong>{mobile}</strong>.</p>
          <div className="pf5-done-pills">
            <span>₹99 Paid</span><span>Submitted</span><span>Processing</span>
          </div>
          <div className="pf5-footer">
            <Link href="/egypt-visa" className="pf5-cta-btn" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ? Back to Egypt Visa
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/egypt-visa">Egypt Visa</Link><span> / </span><span>Apply</span>
      </div>
      <div className="pf5-card">
