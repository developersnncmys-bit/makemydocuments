...
import {
  User, MapPin, Phone, Check, AlertCircle, Wallet, IndianRupee, CreditCard,
    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Your Senior Citizen Card application is submitted. Updates will be sent to <strong>{mobile}</strong>.</p>
          <div className="pf5-done-pills">
            <span>₹300 Paid</span><span>Submitted</span><span>Processing</span>
          </div>
          <div className="pf5-footer">
            <Link href="/senior-citizen-card" className="pf5-cta-btn" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ? Back to Senior Citizen Card
            </Link>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Secure checkout · ₹300</p>
          <div className="pf5-content">
            <div className="pf5-pay-banner">
              <span className="pf5-pay-label">Payment Amount</span>
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/senior-citizen-card">Senior Citizen Card</Link><span> / </span><span>Apply</span>
      </div>
      <div className="pf5-card">
