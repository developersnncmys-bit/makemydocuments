...
import {
  FileText, User, Home, Users, MapPin, Phone, Check,
    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Your rental agreement application is submitted. Updates will be sent to <strong>{mobile}</strong>.</p>
          <div className="pf5-done-pills">
            <span>₹50 Paid</span><span>Submitted</span><span>Doorstep Delivery</span>
          </div>
          <div className="pf5-footer">
            <Link href="/rental-agreement" className="pf5-cta-btn" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/rental-agreement">Rental Agreement</Link><span> / </span><span>Apply</span>
      </div>
      <div className="pf5-card">
            ...
            <>
              ...
              <Field label="State">
                <ValidInp valid={ownerState !== ''}>
                  <select className="pf5-inp" value={ownerState} onChange={e => { setOwnerState(e.target.value); setOwnerPin('') }}>
            ...
            <>
              ...
              <Field label="State">
                <ValidInp valid={tenantState !== ''}>
                  <select className="pf5-inp" value={tenantState} onChange={e => { setTenantState(e.target.value); setTenantPin('') }}>
                    <option value="">Select State</option>
                    {STATES.map(s => <option key={s}>{s}</option>)}
                  </select>
                </ValidInp>
            ...
            <>
              ...
              <Field label="State">
                <ValidInp valid={shippingState !== ''}>
                  <select className="pf5-inp" value={shippingState} onChange={e => { setShippingState(e.target.value); setShippingPin('') }}>
                    <option value="">Select State</option>
                    {STATES.map(s => <option key={s}>{s}</option>)}
                  </select>
                </ValidInp>
