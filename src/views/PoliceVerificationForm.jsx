...
export default function PoliceVerificationForm() {
  ...
  const validateStep = (s) => {
    ...
    if (s === 2) {
      ...
      if (!placeOfBirth.trim()) return { msg: 'Please enter your place of birth.', step: 2 }
    ...
    return (
      <div className="pf5-page">
        <div className="pf5-card">
          ...
          <p className="pf5-sub">Your application is submitted. Updates will be sent to <strong>{mobile}</strong>.</p>
          <div className="pf5-done-pills">
            <span>₹99 Paid</span><span>Submitted</span><span>Processing</span>
          </div>
          <div className="pf5-footer">
            <Link href="/police-verification" className="pf5-cta-btn" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
              ? Back to Police Verification
            </Link>
          </div>
        </div>
      </div>
        ...
        <div className="pf5-card">
          ...
          <div className="pf5-content">
            <div className="pf5-pay-banner">
              <span className="pf5-pay-label">Amount (Booking Fee)</span>
  ...
  return (
    <div className="pf5-page">
      <div className="pf5-breadcrumb">
        <Link href="/">Home</Link><span> / </span><Link href="/police-verification">Police Verification</Link><span> / </span><span>Apply</span>
      </div>
      <div className="pf5-card">
        ...
        <div className="pf5-content">
          ...
          {step === 3 && (
            <>
              <Field label="House No. and Street Name">
                <ValidInp valid={houseStreet.trim().length > 0}>
                  <input className="pf5-inp" type="text" placeholder="Enter house no. and street name"
